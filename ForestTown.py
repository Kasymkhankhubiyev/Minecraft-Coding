...
buildCastle(x, pos.y, pos.z-1, tower_height+2, tower_width+2, tower_length+2)
...
x = pos.x+2*tower_length+towersdist + west_wall_length
buildCastle(x, pos.y, pos.z+6+north_wall_length, tower_height+2, tower_width+2, tower_length+2)
